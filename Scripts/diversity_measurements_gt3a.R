...
min2 <- as.list(seq(477,567,by=9))
min3 <-as.list("573c")
min4 <- as.list(seq(580,2371,by=9))
min5 <- as.list("2379a")
min6 <- as.list(seq(2384,2411,by=9))
min7 <-as.list(seq(2421,2997,by=9))
max1 <- as.list(seq(9,468,by=9))
max2 <- as.list(seq(476,566,by=9))
max3 <- as.list("573")
max4 <- as.list(seq(579,2379,by=9))
max5 <- as.list("2383")
max6 <- as.list(seq(2392,2410,by=9))
max7 <- as.list(seq(2420,3005,by=9))
#Combining the lists
mins <- c(min1,min2,min3,min4,min5,min6,min7)
maxs <- c(max1,max2,max3,max4,max5,max6,max7)
...
#E2: 384:746(44:84),P7:747:809(85:91),NS2:810:1026 (92:115)
#NS3:1027:1657(116:185),NS4A:1658:1711(186:191)
#NS4B:1712:1972(192:220),NS5A:1973:2420(221:270),NS5B:2421:3011(271:335)
...
desired_amino_acid_windows <- desired_amino_acid_windows %>% 
    mutate(Genome_regions=case_when(numbers < 22 ~ "Core",
                                    ...
                                    numbers >=44 & numbers <= 84 ~ "E2",
                                    numbers >=85 & numbers <=91 ~ "P7",
                                    numbers >= 92 & numbers <=115 ~"NS2",
                                    numbers >= 116 & numbers <= 185 ~"NS3",
                                    numbers >= 186 & numbers <= 191 ~"NS4A",
                                    numbers >=192 & numbers <= 220 ~"NS4B",
                                    numbers >=221 & numbers <= 270 ~"NS5A",
                                    TRUE ~ "NS5B"))
