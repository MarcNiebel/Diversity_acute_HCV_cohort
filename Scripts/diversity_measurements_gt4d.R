...
#P155 sample had two exclusions(388-396,397-405) but was used as the basis for the desired windows 
min1 <- as.list(seq(1,568,by=9))
min2 <- as.list(seq(578,2225,by=9))
min3 <- as.list(seq(2238,2256,by=9))
min4 <- as.list(seq(2264,2354,by=9))
min5 <- as.list(seq(2365,2374,by=9))
min6 <-as.list(("2379d"))
min7 <- as.list(seq(2387,2405,by=9))
min8 <- as.list(seq(2417,2993,by=9))
max1 <-as.list(seq(9,576,by=9))
max1[[64]] <-577
max2 <-as.list(seq(586,2233,by=9))
max3 <-as.list(seq(2246,2255,by=9))
max4 <-as.list(seq(2263,2353,by=9))
max5 <-as.list(seq(2364,2373,by=9))
max6 <-as.list(("2379"))
max7 <-as.list(seq(2386,2404,by=9))
max8 <-as.list(seq(2416,3001,by=9))
#Combining the lists
mins <- c(min1,min2,min3,min4,min5,min6,min7,min8)
maxs <- c(max1,max2,max3,max4,max5,max6,max7,max8)
...
#NS4B:1712:1972(191:219),NS5A:1973:2420(220:269),NS5B:2421:3011(270:333)
