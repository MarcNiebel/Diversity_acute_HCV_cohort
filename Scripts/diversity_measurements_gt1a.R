...
#Calculates the normalised shannon entropy for
...
amino_acid_cooridnates <- lapply(alignment_files, function(name) as.character(stri_match_last(name, regex="\\d{1,}_\\d{1,}")))
#Making of ranges of desired windows
min <- seq(1,2998,by=9)
max <- seq(9,3006,by=9)
desired_amino_acid_windows <- as.data.frame(paste0(min,sep="_",max))
...
#NS3:1027:1657(115:185),NS4A:1658:1711(186:190)
